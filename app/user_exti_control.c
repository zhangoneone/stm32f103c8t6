...
void exti_test(){
	int i =3;
		...
		if(r_event & io_operate_ok == io_operate_ok){//io已经就绪
					exti_obj.init(GPIOE,GPIO_Pin_3,GPIO_PortSourceGPIOE,GPIO_PinSource3,
																EXTI_Line3,EXTI_Trigger_Rising,EXTI3_IRQn,callback1);
					exti_obj.init(GPIOE,GPIO_Pin_4,GPIO_PortSourceGPIOE,GPIO_PinSource4,
																EXTI_Line4,EXTI_Trigger_Rising,EXTI4_IRQn,callback0);
					exti_obj.init(GPIOE,GPIO_Pin_2,GPIO_PortSourceGPIOE,GPIO_PinSource2,
